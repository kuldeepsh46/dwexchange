...
<!-- Mirrored from themewagon.github.io/Gradient-Able-free-bootstrap-admin-template/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 00:54:06 GMT -->
<!-- Added by HTTrack -->
...
<script>
    $('#logout').on('click', function(event) {
        ...
        $.ajax({
            url: '/dwexchange/User/userFunctions.php', // Replace with your server URL
            type: 'POST',
            data: {
                'type': 2
            },
