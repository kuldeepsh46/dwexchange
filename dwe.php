...
<!-- Mirrored from templates.iqonic.design/coinex-dist/theme/white/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Aug 2024 00:31:58 GMT -->
<head>
    <title>Dollar Win Exchange | Welcomes</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="iq-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="index.html"><img id="logo_img" class="img-fluid" src="images/logo-white.png" alt="logo"></a>
                        </div>
                        <nav>
                            ...
                            <ul class="menu text-end">
                                ...
                                <li><a href="javascript:void(0)">DWX</a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="javascript:void(0)">Contact</a>
                                  ...
                                  <a class="button mt-4" <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".iq-login" data-bs-whatever="@mdo" style="padding: 14px  35px;">
                          ...
                          <a class="button mt-4" <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".iq-register" data-bs-whatever="@mdo"style="padding: 14px  35px;">
                            <span class="button-inner-box">
                                <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                                <span class="text-btn">Register</span>
                                <span class="icon-two icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                            </span>
                        </a>
                                <!--<li>-->
                                ...
                                <!--    <a class="button" href="customer-support.html">-->
                                <!--        <span class="button-inner-box">-->
                                <!--            <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>-->
    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide justify-content-around align-items-center">
            <div class="ban1-bgimg">
              ...
              <div class="banner-header">
                    ...
                    <small class="banner-dec" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".8" class="my-5 iq-mt-20">Hello and welcome to Dollar Win Exchange!  <br> A next-generation Crypto Exchange platform that provides traders with an unlimited asset, <br>buying and selling feature using real money.</small>
                    <div class="iq-mt-20 d-flex banner-button" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay="1.3" class="iq-mt-20">
                        <a href="javascript:void(0)" class="button  iq-mt-10"><span class="button-inner-box">
                            <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                            <span class="text-btn">Start Trading</span>
                            <span class="icon-two icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                            </span>
                        </a>
                    </div>
              ...
              <div class="banner-img-1">
                 <img data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1.2" data-iq-delay="1.5" src="images/banner/03.png" alt="image">
              </div>
        </div>
        <div class="swiper-slide">
            ...
            <div class="banner-header-2">
                ...
                <h2 data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".9" class="my-4 text-white">Buy, Sell, Exchange Bitcoins with Dollar Win Exchange ! </h2>
                <div class="d-flex justify-content-center banner-img-3" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1.5" data-iq-delay="1.2">
                    ...
                    <img class="img-fluid  me-4" src="images/banner/05.png" alt="">
                    <img class="img-fluid " src="images/banner/051.png" alt="">
                </div>
            </div>
        </div>
        <div class="swiper-slide d-flex justify-content-around align-items-center">
            ...
            <div class="banner-header-3">
                <div class="banner-title-3 iq-mb-20">
                    ...
                    <h2 data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".7" class="banner-title d-flex">Dollar Win Exchange</h2>
                </div>
                <small class=" banner-dec" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay="1">Hello and welcome to Dollar Win Exchange!<br> A next-generation Crypto Exchange platform that provides traders with an unlimited asset,<br>buying and selling feature using real money.</small>
            ...
            <div class="banner-img-2">
                <img data-iq-gsap="onStart" data-iq-position-y="50" data-iq-position-y="-50" data-iq-duration="2" data-iq-delay="1"  src="images/banner/04.png" alt="image">
             </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <script>
                    ...
                    var cccTheme = { "General": { "background": "var(--iq-dark)", "priceText": "var(--white)" }, "Currency": { "color": "var(--white)" } };
                    (function() {
...
<div class="main-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                   ...
                   <div class=" iq-mb-70">
                        <h2 class="title iq-mb-25">How to Trade</h2>
                        <p>Here is 3 Easy Steps to Buy & Sell Cryptocurrencies. </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="images/home/icon/03.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">Create Account</a></h4>
                            <p>Register with Dollar Win Exchane, Fill Up Your Form, Sign up and Start your trade journy.</p>
                ...
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="images/home/icon/01.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">Buy & Desposit Crypto</a></h4>
                            <p>Add funds to your dwexchange.pro account to access crypto services.</p>                                <a href="javascript:void(0)">Read More <i aria-hidden="true" class="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="images/home/icon/02.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">Buy or Sell Coin</a></h4>
                            <p>Explore crypto opportunities within the dwexchange.pro ecosystem.</p>                                <a href="javascript:void(0)">Read More <i aria-hidden="true" class="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 iq-mb-80">
                    ...
                    <p class="text-white iq-mt-25">We started as a Centralized Exchange. Evolved into the whole Crypto Experience. We are the Crypto Experts and Creative Explorers in a digital assets universe.Your Captivating Expedition to the frontiers of finance!</p>
                    <ul class="listing-hand text-white">
                        <li class="iq-mt-20">Team works on mining algos, develops the best mining chip of the time.</li>
                        <li class="iq-mt-20">Instant Sell, liquid staking, collateralized loans debuted.</li>
                        <li class="iq-mt-20">Introducing the simplest way to buy cryptocurrency - Instant Buy.</li>
                        <li class="iq-mt-20">dwexchange.pro WebApp, the crypto super app, goes to market.</li>
                    ...
                    <div class="calculator white-bg iq-pall-30">
                        ...
                        <p>We are launching very soon Currency Calculator where you can easyly calculate your crypto's value in every crypto currency or digital currency.</p>
                        <script src="../../../../www.cryptonator.com/ui/js/widget/calc_widget.html"></script>
                        <!-- <a href="javascript:void(0)" class="button dark iq-mt-10">Buy Now!</a> -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2 class="title iq-mb-25">Cryptocurrency Features</h2>
                        <p>Cryptocurrencies are digital currencies that use encryption algorithms as an alternative form of payment. They have several features, including: </p>
                    </div>
                </div>
            </div>
            <div class="row h-100">
                <div class="col-lg-4 col-md-12 text-end">
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            ...
                            <p>Cryptocurrency's transaction speed is very fast within any network.</p>
                            </div>
                            <div class="ms-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            ...
                            <p>Cryptocurrencies are secured by cryptography, which makes them nearly impossible to counterfeit or double-spend. </p>
                            </div>
                            <div class="ms-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            ...
                            <p>dwexchange.pro is a safe and trustable cryptocurrency exchange where you can trust and trade for all cryptocoins and swap and coin to any coin. </p>
                            </div>
                            <div class="ms-3">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3"><a href="services-details.html">Web Apps</a></h4>
                            <p>dwexchange.pro's web app is very simple and user friendly app here you can easily operate anything and trade very fast </p>
                        </div>  
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                        ...
                        <div class="iq-feature2 iq-mtb-20">
                            ...
                            <p>Trade with dwexchange. Trading Market available 24/7. Crypto Deposits & Withdrawals. Deposit from Bank, Withdraw to Bank... </p>
                        </div>  
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                        ...
                        <div class="iq-feature2 iq-mtb-20">
                            ...
                            <p>Subscribe to dwexchange.pro University updates, and receive our newsletter packed with useful guides and tips every week. </p>
                        </div>  
                    </div>
                </div>
    ...
    <!-- Features -->
    <!-- Bitcoin Charts -->
    <section class="overview-block-ptb  grey-bg coinex-charts">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="">
                        <h2 class="title  iq-mb-25">About Crypto</h2>
                    </div>
                    <p> The crypto markets have proven themselves to be a volatile yet viable market with legitimate profit potential. With a solid understanding of the history, technology, philosophy, and pragmatic design of crypto, let’s get to the purpose of dwexchange.pro University.

                        dwexchange.pro University is here to empower you with the knowledge necessary to generate profits by trading and investing in crypto. </p>
                    <a class="button mt-4" href="javascript:void(0)">
                        <span class="button-inner-box">
                            <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-6 col-md-12 ">
                    <div class="">
                        ...
                        <h2 class="title  iq-mb-25">Why CryptoCurrency</h2>
                        <p>The cryptographic design of crypto is much safer than cloud-hosted banking and broker accounts. If you have your private keys and use best practices to store your cryptocurrency, it is virtually impossible to hack.</p>
                    </div>
                    <div class="iq-feature3 iq-mt-60">
                        ...
                        <div class="fancy-content">
                            <h4 class=" mb-3">Fast Transaction</h4>
                            <p>Compared to traditional money, transacting in crypto is way faster. Sending crypto across the world can be completed in minutes, and at less of a cost than an ACH or wire transfer.</p>
                        </div>
                    </div>
                    <div class="iq-feature3 iq-mtb-40">
                        ...
                        <div class="fancy-content">
                            <h4 class=" mb-3">Inexpensive</h4>
                            <p> The cost of keeping a blockchain running is shared across the network. Transactions are performed at much lower costs compared to a server in a data center.</p>
                        </div>
                    </div>
                    <div class="iq-feature3 iq-mb-80">
                        ...
                        <div class="fancy-content">
                            ...
                            <p>the P2P system allows for transactions to go from point A to point B without being filtered for metadata, ad identifiers, or other intermediaries.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-8 text-center iq-need-help">
                    ...
                    <ul class="list-inline iq-mt-60 mb-4">
                        <li class="list-inline-item iq-font-yellow"><i class="fa fa-phone me-2" aria-hidden="true"></i> +971-4-367 2548</li>
                        <li class="list-inline-item text-white ms-3"><i class="fa fa-envelope-open me-2" aria-hidden="true"></i>helpdesk@dwexchange.pro</li>
                    </ul>
                    <div class="text-white iq-mt-10">For more informatin and knowlege about crypocurrency Subscribe to dwexchange.pro University updates, and receive our newsletter packed with useful guides and tips every week.</div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="iq-testimonial text-center">
                        <div id="testimonial-slider" class="owl-carousel owl-theme owl-loaded" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                            <div class="testimonial ">
                                <p class="description ">
                                    The web content provided by dwexchange.pro is for educational purposes only. The information and tools provided neither are, nor should be construed as, an offer, or a solicitation of an offer, or a recommendation, to buy, sell or hold any digital asset or to open a particular account or engage in any specific investment strategy.
                                </p>
                                <h5 class="fw-bold ">Rinks Cooper</h5>
                                <small>CEO, Dollar Win Exchange</small>
                            </div>
                            <div class="testimonial ">
                                <p class="description ">
                                    The web content provided by dwexchange.pro is for educational purposes only. The information and tools provided neither are, nor should be construed as, an offer, or a solicitation of an offer, or a recommendation, to buy, sell or hold any digital asset or to open a particular account or engage in any specific investment strategy.
                            ...
                            <div class="testimonial ">
                                <p class="description ">
                                    The web content provided by dwexchange.pro is for educational purposes. The information and tools provided neither are, nor should be construed as, an offer or a solicitation of an offer, to buy, sell or hold any digital asset or to open a particular account or engage in any specific investment strategy.
                                </p>
...
<footer class="iq-footer dark-bg iq-footer-2">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 iq-mtb-90">
                    <div class="logo">
                        ...
                        <div class="text-white iq-mt-25 ">With dwexchange.pro you can buy, sell, trade, and earn cryptocurrencies and manage your Transaction most efficiently and securely.</div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12  iq-contact iq-mtb-90 footer-menu-list">
                    ...
                    <ul class="iq-pl-0 ">
                        <li><a href= "#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>About Us</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Services</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Faq</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Team</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Contact Us</a></li>
                    </ul>
                    <ul class="ms-5">
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Market Date</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Event</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Clients</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Pricing</a></li>
                        <li><a href="#"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Blog</a></li>
                    </ul>
                </div>
                </div>
                <div class="col-lg-3 col-md-6   iq-mtb-90">
                    ...
                    <ul class="iq-post">
                        ...
                        <li>
                            ...
                            <div class="iq-font-yellow iq-date">Aug 13, 2024</div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 iq-contact iq-mtb-90">
                    <h5 class="small-title text-white widget-title">CONTACT</h5>
                    <div class="iq-mb-30">
                        <div class="blog"><i class="ion-ios-telephone-outline"></i>
                            <div class="content ">
                                <div class=" title ">Phone</div> +971-4-367 2548 </div>
                        </div>
                    </div>
                    <div class="iq-mb-30">
                        <div class="blog "><i class="ion-ios-email-outline"></i>
                            <div class="content ">
                                <div class=" title ">Mail</div> helpdesk@dwexchange.pro</div>
                        </div>
                    </div>
                    <div class="blog"><i class="ion-ios-location-outline"></i>
                        <div class="content ">
                            <div class=" title ">Address</div> Boulevard Plaza, Tower-2, 9th Floor, Dubai</div>
                    </div>
                </div>
    ...
    <div class="footer-bottom iq-ptb-20 ">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="iq-copyright iq-mt-10 text-white">Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="javascript:void(0)">DWExchange</a> All Rights Reserved </div>
                </div>
                <div class="col-sm-6">
                    <ul  class="footer-nav-menu"><li  class=""><a href="about-us.html">About Us</a></li>
...
Login -->
                ...
                <div class="modal-body">
                    <form id="userSignin">
                        ...
                        <div class="form-group">
                         ...
                         <!--<a class="button iq-mtb-10" href="User/index.html">Sign In</a> -->
                         <button class="button iq-mtb-10" type="submit">Sign In</button>
                         <input type="hidden" name="type" value="1" />
                        <!--<a class="button iq-mtb-10" href="User/index.html">-->
                        <!--    <span class="button-inner-box">-->
                        <!--        <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>-->
    ...
    <!--                    <form class="md-float-material" id="userSignin">-->
    <!--                        <div class="text-center">-->
...
Register -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="userRegistration">
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" id="refCode" name="refCode" placeholder="Sponsor Id" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" required>I Agree to the Terms and Conditions</label>
                        </div>
                        <p>Taxes may be payable on any return and/or on any increase in the value of your digital assets and you should seek independent advice on your tax obligations.</p>
                        <!--<a class="button iq-mtb-10" href="javascript:void(0)">-->
                        <!--    <span class="button-inner-box">-->
                        <!--        <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>-->
                                <!--<span class="text-btn">Sign Up</span>-->
                        <!--        <button class="text-btn" type="submit">Sign Up</button>-->
                        <!--        <span class="icon-two icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>-->
                        <!--    </span>-->
                        <!--</a>                  -->
                        <button class="button iq-mtb-10" type="submit">Sign Up</button>
    ...
    <!--                    <form class="md-float-material" id="userRegistration">-->
    <!--                        <div class="text-center">-->
    <!--                            <img src="assets/images/logo.png" alt="logo.png">-->
    <!--                        </div>-->
    <!--                        <div class="auth-box">-->
    ...
    <!--                                    <div class="checkbox-fade fade-in-primary">-->
    <!--                                        <label>-->
    <!--                                            <input type="checkbox" value="" id="termsConditions" name="termsConditions">-->
    <!--                                            <span class="cr"><i-->
    ...
    <!--                                <div class="col-md-12">-->
    <!--                                    <button type="submit"-->
    <!--                                        class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" name="register">Sign-->
    <!--                                        up now.</button>-->
    <!--                                        <input type="hidden" name="type" value="0" />-->
    <!--                                </div>-->
    <!--                            </div>-->
